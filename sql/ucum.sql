create or replace function ucum.init() returns void 
language plv8
as
$function$
...
create or replace function ucum.convert(v float,f text,t text) 
returns float
language plv8 IMMUTABLE STRICT
as
$$
return ucum.convert(v,f,t);
$$;

create or replace function ucum.parse(unit text) 
returns json
language plv8 IMMUTABLE STRICT
as
$$
return ucum.parse(unit);
$$;

create or replace function ucum.canonicalize(unit text) 
returns json
language plv8 IMMUTABLE STRICT
as
$$
return ucum.canonicalize(unit);
$$;
